...
$sql = "SELECT * FROM tb_lugar_asignacion;";
        ...
        <tfoot>
         ...
         <tbody>
					<?php while($fila = $result->fetch_assoc()) { 
						...
						<tr>
							<td><?php echo $fila['id_lugar_asignacion']; ?></td>
							...
							<td><span class="label label-<?php echo $class; ?>"><?php echo $estado?></span></td>
                                                        <td> <button
                                                                class='btn btn-info' title='Editar Lugar Asigancion' onclick="editarLugarasignacion(<?php echo $fila['id_lugar_asignacion']?>)"><i class="bi bi-pencil-square"></i></button>
                                                            <?php 
//                                                            if($idrolUsuario==1){
                                                            ?>
                                                            <button  class='btn btn-danger' title='Eliminar Lugar Asigancion ' onclick="eliminarLugarasignacion(<?php echo $fila['id_lugar_asignacion']?>)"><i class="bi bi-trash3"></i></button>

...
<table cellspacing="0" style="width: 100%; text-align: left; font-size: 11pt;">
           <tr>
           		<td style="width:100%;" class='midnight-blue'>REPORTE DE ESTUDIANTES GENERAL</td>
           </tr>
</table>
...
and tb_estudiantes.id_carreras= tb_carreras.id_carreras and tb_estudiantes.id_cursos= tb_cursos.id_cursos and tb_estudiantes.estado='$prueba';";
